...
namespace InspectionSystem.Tests.ViewModels
{
    ...
    public class InspectionViewModelTests
    {
        ...
        [Test]
        public void Constructor_InitialState_StatusMessageNotEmpty()
        {
        ...
        public async Task RunInspectionCommand_ModelNotLoaded_StatusMessageUpdated()
        {
            ...
            Assert.That(_viewModel.StatusMessage, Does.Contain("not loaded")
                .Or.Contain("No image"));
        }
        ...
        public async Task RunInspectionCommand_NoImageLoaded_StatusMessageUpdated()
        {
            ...
            Assert.That(vm.StatusMessage, Does.Contain("No image")
                .Or.Contain("not loaded"));
        }
        ...
        [Test]
        public void ResultLabel_InitialState_IsNoResult()
        {
            Assert.That(_viewModel.ResultLabel, Is.EqualTo("NO RESULT"));
        }

        [Test]
        public void DetectionCount_InitialState_IsZero()
        {
